        ...
        <script dangerouslySetInnerHTML={{ __html: `
          ...
          document.addEventListener('htmx:afterRequest', function(evt) {
            ...
            if (status !== 200 && !hasRedirect && target.innerHTML.trim() === '') {
              target.innerHTML = '<div class="alert bg-rose-600 text-white border border-rose-700 shadow-lg rounded-xl flex items-center gap-2"><i data-lucide="alert-circle" class="w-5 h-5"></i><span>\u30ED\u30B0\u30A4\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F\uFF08\u30B9\u30C6\u30FC\u30BF\u30B9: ' + status + '\uFF09\u3002\u8A8D\u8A3C\u60C5\u5831\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002</span></div>';
              lucide.createIcons();
            }
          });
        ` }} />
